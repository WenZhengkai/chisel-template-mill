...
```sh
git clone git@github.com:WenZhengkai/chisel-template-mill.git
cd chisel-template-mill
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-template-mill'
...
```sh
mill chisel-template-mill.test
```
